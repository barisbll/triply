...
const CreateATouristicPlaceDetail = () => {
  const [touristicPlaceName, setTouristicPlaceName] = useState(null);
  ...
  useEffect(() => {
    if (queryParams.get("id")) {
      ...
      setTouristicPlaceName(queryParams.get("name"));
    ...
    <div>
      <form className="col-lg-6 offset-lg-3 col-md-8 offset-md-2">
        <div className="form-group mt-5">
          <label htmlFor="touristic-place-name" className="mb-1">
            Name of the Touristic Place:
          </label>
          <input
            className="form-control"
            type="text"
            id="touristic-place-name"
            placeholder="Enter Touristic Place's Name:"
            value={touristicPlaceName}
            onChange={(e) => {
...
export default CreateATouristicPlaceDetail;
