...
const CreateAnAccomadationDetail = () => {
  const [accomadationName, setAccomadationName] = useState(null);
  ...
  useEffect(() => {
    if (queryParams.get("id")) {
      ...
      setAccomadationName(queryParams.get("name"));
    ...
    <div>
      <form className="col-lg-6 offset-lg-3 col-md-8 offset-md-2">
        <div className="form-group mt-5">
          <label htmlFor="accomadation-name" className="mb-1">
            Name of the Accomadation:
          </label>
          <input
            className="form-control"
            type="text"
            id="accomadation-name"
            placeholder="Enter Accomadation's Name:"
            value={accomadationName}
            onChange={(e) => {
              setAccomadationName(e.target.value);
            }}
          />
        </div>
...
export default CreateAnAccomadationDetail;
